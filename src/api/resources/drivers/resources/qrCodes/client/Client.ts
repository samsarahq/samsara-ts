...
export declare namespace QrCodes {
...
export class QrCodes {
    protected readonly _options: QrCodes.Options;

    constructor(_options: QrCodes.Options = {}) {
     ...
     *
     * @param {SamsaraApi.drivers.QrCodesListRequest} request
     * @param {QrCodes.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<SamsaraApi.DriverQrCodesGetDriversQrCodesResponseBody> {
    ...
    private async __list(
        request: SamsaraApi.drivers.QrCodesListRequest = {},
        requestOptions?: QrCodes.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.DriverQrCodesGetDriversQrCodesResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.DriverQrCodesGetDriversQrCodesResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /drivers/qr-codes.");
            case "unknown":
                throw new errors.SamsaraApiError({
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.drivers.DriverQrCodesCreateDriverQrCodeRequestBody} request
     * @param {QrCodes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public create(
        ...
        requestOptions?: QrCodes.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.DriverQrCodesCreateDriverQrCodeResponseBody> {
    ...
    private async __create(
        request: SamsaraApi.drivers.DriverQrCodesCreateDriverQrCodeRequestBody,
        requestOptions?: QrCodes.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.DriverQrCodesCreateDriverQrCodeResponseBody>> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.DriverQrCodesCreateDriverQrCodeResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling POST /drivers/qr-codes.");
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.drivers.DriverQrCodesDeleteDriverQrCodeRequestBody} request
     * @param {QrCodes.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling DELETE /drivers/qr-codes.");
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
