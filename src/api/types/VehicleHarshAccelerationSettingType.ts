...
export const VehicleHarshAccelerationSettingType = {
...
export type VehicleHarshAccelerationSettingType =
    (typeof VehicleHarshAccelerationSettingType)[keyof typeof VehicleHarshAccelerationSettingType];
