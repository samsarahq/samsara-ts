...
export class Idling {
     ...
     *
     * @param {SamsaraApi.reports.vehicles.IdlingListRequest} request
     ...
     *
     * @example
     *     await client.reports.vehicles.idling.list({
     *         startTime: "startTime",
     *         endTime: "endTime"
     *     })
     */
    public async list(
    ...
    ): Promise<core.Page<SamsaraApi.IdlingReportEventResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.reports.vehicles.IdlingListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.IdlingReportsGetVehicleIdlingReportsResponseBody>> => {
                const {
                    after,
                    limit,
                    startTime,
                ...
                if (isPtoActive != null) {
                    _queryParams["isPtoActive"] = isPtoActive.toString();
                }
                if (minIdlingDurationMinutes != null) {
                    _queryParams["minIdlingDurationMinutes"] = minIdlingDurationMinutes.toString();
                }
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.IdlingReportsGetVehicleIdlingReportsResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError(
                            "Timeout exceeded when calling GET /fleet/reports/vehicle/idling.",
                        );
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<
            SamsaraApi.IdlingReportsGetVehicleIdlingReportsResponseBody,
            SamsaraApi.IdlingReportEventResponseBody
        >({
