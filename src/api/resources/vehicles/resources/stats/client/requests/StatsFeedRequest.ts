...
export interface StatsFeedRequest {
     ...
     */
    types?: Samsara.vehicles.StatsFeedRequestTypesItem | Samsara.vehicles.StatsFeedRequestTypesItem[];
    /**
     ...
     * - `seatbeltDriver`: Seatbelt Driver Status as read from the vehicle. `Buckled` or `Unbuckled`. (Beta only)
     */
    decorations?: Samsara.vehicles.StatsFeedRequestDecorationsItem | Samsara.vehicles.StatsFeedRequestDecorationsItem[];
}
