...
export declare namespace LiveShares {
...
export class LiveShares {
    protected readonly _options: LiveShares.Options;

    constructor(_options: LiveShares.Options = {}) {
     ...
     *
     * @param {SamsaraApi.LiveSharesListRequest} request
     * @param {LiveShares.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @example
     *     await client.liveShares.list()
     */
    public async list(
        request: SamsaraApi.LiveSharesListRequest = {},
        requestOptions?: LiveShares.RequestOptions,
    ): Promise<core.Page<SamsaraApi.LiveSharingLinkFullResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.LiveSharesListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.LiveSharingLinksGetLiveSharingLinksResponseBody>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.LiveSharingLinksGetLiveSharingLinksResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /live-shares.");
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<
            SamsaraApi.LiveSharingLinksGetLiveSharingLinksResponseBody,
            SamsaraApi.LiveSharingLinkFullResponseObjectResponseBody
        >({
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.LiveSharingLinksCreateLiveSharingLinkRequestBody} request
     * @param {LiveShares.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public create(
        ...
        requestOptions?: LiveShares.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.LiveSharingLinksCreateLiveSharingLinkResponseBody> {
    ...
    private async __create(
        request: SamsaraApi.LiveSharingLinksCreateLiveSharingLinkRequestBody,
        requestOptions?: LiveShares.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.LiveSharingLinksCreateLiveSharingLinkResponseBody>> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.LiveSharingLinksCreateLiveSharingLinkResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling POST /live-shares.");
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.LiveSharesDeleteRequest} request
     * @param {LiveShares.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling DELETE /live-shares.");
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.LiveSharingLinksUpdateLiveSharingLinkRequestBody} request
     * @param {LiveShares.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public update(
        ...
        requestOptions?: LiveShares.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.LiveSharingLinksUpdateLiveSharingLinkResponseBody> {
    ...
    private async __update(
        request: SamsaraApi.LiveSharingLinksUpdateLiveSharingLinkRequestBody,
        requestOptions?: LiveShares.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.LiveSharingLinksUpdateLiveSharingLinkResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.LiveSharingLinksUpdateLiveSharingLinkResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling PATCH /live-shares.");
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
