 ...
 */
export interface WebhookResponseResponseBody {
    ...
    eventTypes?: WebhookResponseResponseBody.EventTypes.Item[];
    ...
    version: WebhookResponseResponseBody.Version;
}

export namespace WebhookResponseResponseBody {
