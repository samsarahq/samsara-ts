...
export declare namespace OrganizationInfoClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class OrganizationInfoClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<OrganizationInfoClient.Options>;

    constructor(options: OrganizationInfoClient.Options = {}) {
     ...
     *
     * @param {OrganizationInfoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    ): core.HttpResponsePromise<Samsara.OrganizationInfoResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getOrganizationInfo(requestOptions));
    }

    private async __getOrganizationInfo(
        requestOptions?: OrganizationInfoClient.RequestOptions,
