...
export declare namespace DriverCoachAssignments {
...
export class DriverCoachAssignments {
    protected readonly _options: DriverCoachAssignments.Options;

    constructor(_options: DriverCoachAssignments.Options = {}) {
     ...
     *
     * @param {SamsaraApi.coaching.DriverCoachAssignmentsListRequest} request
     * @param {DriverCoachAssignments.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @example
     *     await client.coaching.driverCoachAssignments.list()
     */
    public async list(
        request: SamsaraApi.coaching.DriverCoachAssignmentsListRequest = {},
        requestOptions?: DriverCoachAssignments.RequestOptions,
    ): Promise<core.Page<SamsaraApi.CoachAssignmentWithDriverExternalIdsResponseResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.coaching.DriverCoachAssignmentsListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody>> => {
                ...
                if (coachIds != null) {
                    if (Array.isArray(coachIds)) {
                        _queryParams["coachIds"] = coachIds.map((item) => item);
                    } else {
                        _queryParams["coachIds"] = coachIds;
                    }
                }
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError(
                            "Timeout exceeded when calling GET /coaching/driver-coach-assignments.",
                        );
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<
            SamsaraApi.DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody,
            SamsaraApi.CoachAssignmentWithDriverExternalIdsResponseResponseBody
        >({
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.coaching.DriverCoachAssignmentsUpdateRequest} request
     * @param {DriverCoachAssignments.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public update(
        ...
        requestOptions?: DriverCoachAssignments.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.DriverCoachAssignmentsPutDriverCoachAssignmentResponseBody> {
    ...
    private async __update(
        request: SamsaraApi.coaching.DriverCoachAssignmentsUpdateRequest,
        requestOptions?: DriverCoachAssignments.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.DriverCoachAssignmentsPutDriverCoachAssignmentResponseBody>> {
        const { driverId, coachId } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        _queryParams["driverId"] = driverId;
        if (coachId != null) {
            _queryParams["coachId"] = coachId;
        }
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.DriverCoachAssignmentsPutDriverCoachAssignmentResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling PUT /coaching/driver-coach-assignments.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
