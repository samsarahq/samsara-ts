...
export class TrainingCourses {
     ...
     *
     * @param {Samsara.TrainingCoursesListRequest} request
    ...
    ): Promise<core.Page<Samsara.TrainingCourseResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraTimeoutError("Timeout exceeded when calling GET /training-courses.");
                    case "unknown":
                        throw new errors.SamsaraError({
