...
export class DriverCoachAssignments {
     ...
     *
     * @param {Samsara.coaching.DriverCoachAssignmentsListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Samsara.CoachAssignmentWithDriverExternalIdsResponseResponseBody>> {
        ...
        return new core.Pageable<
            Samsara.DriverCoachAssignmentsGetDriverCoachAssignmentResponseBody,
            Samsara.CoachAssignmentWithDriverExternalIdsResponseResponseBody
        >({
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {Samsara.coaching.DriverCoachAssignmentsUpdateRequest} request
     * @param {DriverCoachAssignments.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Samsara.UnauthorizedError}
     * @throws {@link Samsara.NotFoundError}
