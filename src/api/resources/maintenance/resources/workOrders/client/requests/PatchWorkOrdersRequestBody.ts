 ...
 *     }
 */
export interface PatchWorkOrdersRequestBody {
    ...
    category?: PatchWorkOrdersRequestBody.Category;
    ...
    priority?: PatchWorkOrdersRequestBody.Priority;
    ...
    status?: PatchWorkOrdersRequestBody.Status;
    tax?: Samsara.WorkOrderTaxObjectRequestBody;
}

export namespace PatchWorkOrdersRequestBody {
    /**
     * The category of the work order  Valid values: `Annual`, `Corrective`, `Damage Repair`, `Preventive`, `Recall`, `Unspecified`
     */
