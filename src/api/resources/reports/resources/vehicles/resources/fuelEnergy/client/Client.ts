...
export class FuelEnergy {
     ...
     *
     * @param {SamsaraApi.reports.vehicles.FuelEnergyListRequest} request
    ...
    ): core.HttpResponsePromise<SamsaraApi.FuelEnergyGetFuelEnergyVehicleReportsResponseBody> {
    ...
    private async __list(
        request: SamsaraApi.reports.vehicles.FuelEnergyListRequest,
        requestOptions?: FuelEnergy.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.FuelEnergyGetFuelEnergyVehicleReportsResponseBody>> {
        ...
        if (energyType != null) {
            _queryParams["energyType"] = energyType;
        }
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.FuelEnergyGetFuelEnergyVehicleReportsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling GET /fleet/reports/vehicles/fuel-energy.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
