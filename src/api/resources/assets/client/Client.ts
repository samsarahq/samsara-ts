...
export class AssetsClient {
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {Samsara.GetAssetLocationRequest} request
     * @param {AssetsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Samsara.UnauthorizedError}
     * @throws {@link Samsara.NotFoundError}
     ...
     *     })
     */
    public getAssetLocation(
        request: Samsara.GetAssetLocationRequest,
        requestOptions?: AssetsClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.AssetLocationsGetAssetLocationResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__getAssetLocation(request, requestOptions));
    }

    private async __getAssetLocation(
        request: Samsara.GetAssetLocationRequest,
        requestOptions?: AssetsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.AssetLocationsGetAssetLocationResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.AssetLocationsGetAssetLocationResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/v1/fleet/assets/{assetId}/locations",
        );
    }
     ...
     *     })
     */
    public getAssetReefer(
        request: Samsara.GetAssetReeferRequest,
        requestOptions?: AssetsClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.AssetsGetAssetReeferResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__getAssetReefer(request, requestOptions));
    }

    private async __getAssetReefer(
        request: Samsara.GetAssetReeferRequest,
        requestOptions?: AssetsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.AssetsGetAssetReeferResponseBody>> {
        const { assetId, startMs, endMs } = request;
        const _queryParams: Record<string, unknown> = {
            startMs,
            endMs,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.AssetsGetAssetReeferResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/v1/fleet/assets/{assetId}/reefer",
        );
    }
