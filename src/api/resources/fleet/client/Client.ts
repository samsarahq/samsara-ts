...
export class FleetClient {
     ...
     *
     * @param {Samsara.GetFleetLocationsRequest} request
     ...
     */
    public getFleetLocations(
        request: Samsara.GetFleetLocationsRequest = {},
        requestOptions?: FleetClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.FleetLocationsGetFleetLocationsResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__getFleetLocations(request, requestOptions));
    }

    private async __getFleetLocations(
        request: Samsara.GetFleetLocationsRequest = {},
        requestOptions?: FleetClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.FleetLocationsGetFleetLocationsResponseBody>> {
        const { after, limit, vehicleIds, tagIds } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.FleetLocationsGetFleetLocationsResponseBody,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/fleet/locations");
    }
}
