...
export interface WebhooksGetWebhookResponseBody {
    ...
    eventTypes?: WebhooksGetWebhookResponseBody.EventTypes.Item[];
    ...
    version: WebhooksGetWebhookResponseBody.Version;
}

export namespace WebhooksGetWebhookResponseBody {
