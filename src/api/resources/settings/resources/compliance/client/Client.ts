...
export class Compliance {
    ...
    ): core.HttpResponsePromise<SamsaraApi.SettingsGetComplianceSettingsResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: Compliance.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.SettingsGetComplianceSettingsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.SettingsGetComplianceSettingsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling GET /fleet/settings/compliance.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.settings.SettingsPatchComplianceSettingsRequestBody} request
     * @param {Compliance.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public update(
        ...
        requestOptions?: Compliance.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.SettingsPatchComplianceSettingsResponseBody> {
    ...
    private async __update(
        request: SamsaraApi.settings.SettingsPatchComplianceSettingsRequestBody = {},
        requestOptions?: Compliance.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.SettingsPatchComplianceSettingsResponseBody>> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.SettingsPatchComplianceSettingsResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling PATCH /fleet/settings/compliance.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
                    message: _response.error.errorMessage,
