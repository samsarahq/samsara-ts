...
export declare namespace TrainingCourses {
...
export class TrainingCourses {
    protected readonly _options: TrainingCourses.Options;

    constructor(_options: TrainingCourses.Options = {}) {
     ...
     *
     * @param {SamsaraApi.TrainingCoursesListRequest} request
     * @param {TrainingCourses.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @example
     *     await client.trainingCourses.list()
     */
    public async list(
        request: SamsaraApi.TrainingCoursesListRequest = {},
        requestOptions?: TrainingCourses.RequestOptions,
    ): Promise<core.Page<SamsaraApi.TrainingCourseResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.TrainingCoursesListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.TrainingCoursesGetTrainingCoursesResponseBody>> => {
                ...
                if (categoryIds != null) {
                    if (Array.isArray(categoryIds)) {
                        _queryParams["categoryIds"] = categoryIds.map((item) => item);
                    } else {
                        _queryParams["categoryIds"] = categoryIds;
                    }
                }
                if (status != null) {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.TrainingCoursesGetTrainingCoursesResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /training-courses.");
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<
            SamsaraApi.TrainingCoursesGetTrainingCoursesResponseBody,
            SamsaraApi.TrainingCourseResponseObjectResponseBody
        >({
