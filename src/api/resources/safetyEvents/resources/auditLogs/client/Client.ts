...
export class AuditLogs {
     ...
     *
     * @param {Samsara.safetyEvents.AuditLogsFeedRequest} request
    ...
    public async feed(
    ...
    ): Promise<core.Page<Samsara.SafetyEventActivityFeedItemResponseBody>> {
        ...
        return new core.Pageable<
            Samsara.SafetyEventsGetSafetyActivityEventFeedResponseBody,
            Samsara.SafetyEventActivityFeedItemResponseBody
        >({
