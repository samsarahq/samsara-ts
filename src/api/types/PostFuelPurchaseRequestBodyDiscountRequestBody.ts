 ...
 */
export interface PostFuelPurchaseRequestBodyDiscountRequestBody {
    /** The money amount. */
    amount: string;
    /** The currency of money. This is a 3-letter ISO 4217 currency code.  Valid values: `usd`, `gbp`, `cad`, `eur`, `chf`, `mxn` */
    currency: PostFuelPurchaseRequestBodyDiscountRequestBody.Currency;
}

export namespace PostFuelPurchaseRequestBodyDiscountRequestBody {
    /** The currency of money. This is a 3-letter ISO 4217 currency code.  Valid values: `usd`, `gbp`, `cad`, `eur`, `chf`, `mxn` */
