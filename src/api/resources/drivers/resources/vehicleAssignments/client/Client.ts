...
export class VehicleAssignments {
     ...
     *
     * @param {SamsaraApi.drivers.VehicleAssignmentsListRequest} request
    ...
    ): core.HttpResponsePromise<SamsaraApi.DriversVehicleAssignmentsGetDriversVehicleAssignmentsResponseBody> {
    ...
    private async __list(
        request: SamsaraApi.drivers.VehicleAssignmentsListRequest = {},
        requestOptions?: VehicleAssignments.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.DriversVehicleAssignmentsGetDriversVehicleAssignmentsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.DriversVehicleAssignmentsGetDriversVehicleAssignmentsResponseBody,
