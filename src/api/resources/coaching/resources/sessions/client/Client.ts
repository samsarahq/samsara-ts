...
export class Sessions {
     ...
     *
     * @param {SamsaraApi.coaching.SessionsStreamRequest} request
    ...
    public async stream(
    ...
    ): Promise<core.Page<SamsaraApi.CoachingSessionsResponseResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.coaching.SessionsStreamRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.CoachingSessionsGetCoachingSessionsResponseBody>> => {
                const {
                    driverIds,
                    coachIds,
                    sessionStatuses,
                ...
                if (sessionStatuses != null) {
                    if (Array.isArray(sessionStatuses)) {
                        _queryParams["sessionStatuses"] = sessionStatuses.map((item) => item);
                    } else {
                        _queryParams["sessionStatuses"] = sessionStatuses;
                    }
                }
                if (includeCoachableEvents != null) {
                    _queryParams["includeCoachableEvents"] = includeCoachableEvents.toString();
                }
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.CoachingSessionsGetCoachingSessionsResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError(
                            "Timeout exceeded when calling GET /coaching/sessions/stream.",
                        );
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<
            SamsaraApi.CoachingSessionsGetCoachingSessionsResponseBody,
            SamsaraApi.CoachingSessionsResponseResponseBody
        >({
