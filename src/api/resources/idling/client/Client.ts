...
export class Idling {
     ...
     *
     * @param {Samsara.IdlingListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Samsara.IdlingEventObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraTimeoutError("Timeout exceeded when calling GET /idling/events.");
                    case "unknown":
                        throw new errors.SamsaraError({
        ...
        return new core.Pageable<
            Samsara.AdvancedIdlingGetIdlingEventsResponseBody,
            Samsara.IdlingEventObjectResponseBody
        >({
