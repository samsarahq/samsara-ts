...
export class ServiceTasks {
     ...
     *
     * @param {Samsara.maintenance.ServiceTasksListRequest} request
    ...
    ): Promise<core.Page<Samsara.ServiceTaskDefinitionObjectResponseBody>> {
    ...
    private async __create(requestOptions?: ServiceTasks.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraTimeoutError("Timeout exceeded when calling POST /maintenance/service-tasks.");
            case "unknown":
                throw new errors.SamsaraError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __update(requestOptions?: ServiceTasks.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraTimeoutError("Timeout exceeded when calling PATCH /maintenance/service-tasks.");
            case "unknown":
                throw new errors.SamsaraError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
