...
export class Inputs {
     ...
     *
     * @param {SamsaraApi.InputsStreamRequest} request
    ...
    public async stream(
    ...
    ): Promise<core.Page<SamsaraApi.AssetsInputsResponseResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.InputsStreamRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.AssetsInputsGetAssetsInputsResponseBody>> => {
                const {
                    ids,
                    type: type_,
                    after,
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.AssetsInputsGetAssetsInputsResponseBody,
        ...
        return new core.Pageable<
            SamsaraApi.AssetsInputsGetAssetsInputsResponseBody,
            SamsaraApi.AssetsInputsResponseResponseBody
        >({
