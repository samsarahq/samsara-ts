...
export class Forms {
     ...
     *
     * @param {SamsaraApi.GetFormTemplatesRequest} request
    ...
    ): core.HttpResponsePromise<SamsaraApi.FormTemplatesGetFormTemplatesResponseBody> {
    ...
    private async __getFormTemplates(
        request: SamsaraApi.GetFormTemplatesRequest = {},
        requestOptions?: Forms.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.FormTemplatesGetFormTemplatesResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.FormTemplatesGetFormTemplatesResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /form-templates.");
            case "unknown":
                throw new errors.SamsaraApiError({
