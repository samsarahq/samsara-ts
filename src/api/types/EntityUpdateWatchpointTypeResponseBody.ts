 ...
 * Watchpoint object
 */
export interface EntityUpdateWatchpointTypeResponseBody {
    ...
    mode: EntityUpdateWatchpointTypeResponseBody.Mode;
    ...
    observationType: EntityUpdateWatchpointTypeResponseBody.ObservationType;
    ...
    status: EntityUpdateWatchpointTypeResponseBody.Status;
    /** Time when the public watchpoint projection was most recently updated. */
    updatedAtTime: string;
}

export namespace EntityUpdateWatchpointTypeResponseBody {
    /** Recurrence frequency for observations.  Valid values: `unknown`, `justOnce`, `daily`, `weekly`, `monthly` */
    export const Mode = {
        Unknown: "unknown",
        JustOnce: "justOnce",
