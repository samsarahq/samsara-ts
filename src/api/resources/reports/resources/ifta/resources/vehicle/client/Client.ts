...
export class Vehicle {
     ...
     *
     * @param {SamsaraApi.reports.ifta.VehicleListRequest} request
    ...
    ): core.HttpResponsePromise<SamsaraApi.IftaGetIftaVehicleReportsResponseBody> {
    ...
    private async __list(
        request: SamsaraApi.reports.ifta.VehicleListRequest,
        requestOptions?: Vehicle.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.IftaGetIftaVehicleReportsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.IftaGetIftaVehicleReportsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling GET /fleet/reports/ifta/vehicle.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
