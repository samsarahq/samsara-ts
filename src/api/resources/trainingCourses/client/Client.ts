...
export declare namespace TrainingCoursesClient {
...
export class TrainingCoursesClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<TrainingCoursesClient.Options>;

    constructor(options: TrainingCoursesClient.Options = {}) {
     ...
     * @param {TrainingCoursesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
