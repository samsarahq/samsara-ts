...
export class Safety {
    protected readonly _options: Safety.Options;

    constructor(_options: Safety.Options = {}) {
     ...
     *
     * @param {Safety.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<SamsaraApi.SafetySettingsGetSafetySettingsResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: Safety.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.SafetySettingsGetSafetySettingsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.SafetySettingsGetSafetySettingsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /fleet/settings/safety.");
            case "unknown":
                throw new errors.SamsaraApiError({
