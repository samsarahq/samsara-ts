...
export class Idling {
     ...
     *
     * @param {Samsara.reports.vehicles.IdlingListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Samsara.IdlingReportEventResponseBody>> {
        ...
        return new core.Pageable<
            Samsara.IdlingReportsGetVehicleIdlingReportsResponseBody,
            Samsara.IdlingReportEventResponseBody
        >({
