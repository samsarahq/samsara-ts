...
export class LocationAndSpeed {
     ...
     *
     * @param {Samsara.assets.LocationAndSpeedStreamRequest} request
    ...
    public async stream(
    ...
    ): Promise<core.Page<Samsara.LocationAndSpeedResponseResponseBody>> {
        ...
        return new core.Pageable<
            Samsara.LocationAndSpeedGetLocationAndSpeedResponseBody,
            Samsara.LocationAndSpeedResponseResponseBody
        >({
