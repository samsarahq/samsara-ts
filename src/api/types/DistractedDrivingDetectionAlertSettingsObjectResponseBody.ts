...
export interface DistractedDrivingDetectionAlertSettingsObjectResponseBody {
    inattentiveDrivingDetectionAlerts?: SamsaraApi.InattentiveDrivingDetectionAlertSettingsObjectResponseBody;
    /** Indicates whether AI event detection for distracted driving behaviors is turned on. */
    isEnabled?: boolean;
    mobileUsageDetectionAlerts?: SamsaraApi.MobileUsageDetectionAlertSettingsObjectResponseBody;
}
