...
describe("BetaApIsClient", () => {
    ...
    test("postTrainingAssignments (1)", async () => {
        ...
        const response = await client.betaApIs.postTrainingAssignments({
            courseId: "courseId",
            dueAtTime: "dueAtTime",
        });
        expect(response).toEqual({
    ...
    test("postTrainingAssignments (2)", async () => {
        ...
        await expect(async () => {
            return await client.betaApIs.postTrainingAssignments({
                courseId: "courseId",
                dueAtTime: "dueAtTime",
            });
        }).rejects.toThrow(Samsara.UnauthorizedError);
    ...
    test("deleteTrainingAssignments (1)", async () => {
        ...
        const response = await client.betaApIs.deleteTrainingAssignments();
        expect(response).toEqual(undefined);
    });
    ...
    test("deleteTrainingAssignments (2)", async () => {
        ...
        await expect(async () => {
            return await client.betaApIs.deleteTrainingAssignments();
        }).rejects.toThrow(Samsara.UnauthorizedError);
    });
    ...
    test("patchTrainingAssignments (1)", async () => {
        ...
        const response = await client.betaApIs.patchTrainingAssignments({
            dueAtTime: "dueAtTime",
        });
        expect(response).toEqual({
            data: [
    ...
    test("patchTrainingAssignments (2)", async () => {
        ...
        await expect(async () => {
            return await client.betaApIs.patchTrainingAssignments({
                dueAtTime: "dueAtTime",
            });
        }).rejects.toThrow(Samsara.UnauthorizedError);
    });
    ...
    test("getTrainingAssignmentsStream (1)", async () => {
        ...
        const response = await client.betaApIs.getTrainingAssignmentsStream({
            startTime: "startTime",
        });
        expect(response).toEqual({
            data: [
    ...
    test("getTrainingAssignmentsStream (2)", async () => {
        ...
        await expect(async () => {
            return await client.betaApIs.getTrainingAssignmentsStream({
                startTime: "startTime",
            });
        }).rejects.toThrow(Samsara.UnauthorizedError);
    });
    ...
    test("getTrainingCourses (1)", async () => {
        ...
        const response = await client.betaApIs.getTrainingCourses();
        expect(response).toEqual({
            data: [
                {
                    category: {
    ...
    test("getTrainingCourses (2)", async () => {
        ...
        await expect(async () => {
            return await client.betaApIs.getTrainingCourses();
        }).rejects.toThrow(Samsara.UnauthorizedError);
    });
