 ...
 */
export interface UpdatePurchaseOrderEntityPurchaseOrderPurchaseOrderPartInputTypeRequestBody {
    ...
    unitCost?: Samsara.UpdatePurchaseOrderEntityPurchaseOrderMoneyInputTypeRequestBody | undefined;
