...
export class BetaApIsClient {
     ...
     */
    public listCarbCtcVehicles(
        request: Samsara.ListCarbCtcVehiclesRequest = {},
        requestOptions?: BetaApIsClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.CarbCtcListCarbCtcVehiclesResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__listCarbCtcVehicles(request, requestOptions));
    }

    private async __listCarbCtcVehicles(
        request: Samsara.ListCarbCtcVehiclesRequest = {},
        requestOptions?: BetaApIsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.CarbCtcListCarbCtcVehiclesResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.CarbCtcListCarbCtcVehiclesResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/fleet/carb-ctc/vehicles");
    }
     ...
     *     })
     */
    public listCarbCtcVehicleHistory(
        request: Samsara.ListCarbCtcVehicleHistoryRequest,
        requestOptions?: BetaApIsClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.CarbCtcListCarbCtcVehicleHistoryResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__listCarbCtcVehicleHistory(request, requestOptions));
    }

    private async __listCarbCtcVehicleHistory(
        request: Samsara.ListCarbCtcVehicleHistoryRequest,
        requestOptions?: BetaApIsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.CarbCtcListCarbCtcVehicleHistoryResponseBody>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SamsaraEnvironment.ProductionApi,
                "fleet/carb-ctc/vehicles/history",
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.CarbCtcListCarbCtcVehicleHistoryResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
