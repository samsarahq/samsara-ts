 ...
 */
export interface ReportsDatasetFieldResponseBody {
    /** Data type of the field.  Valid values: `string`, `integer`, `float`, `timestamp`, `unknown` */
    dataType: ReportsDatasetFieldResponseBody.DataType;
    ...
    unit?: ReportsDatasetFieldResponseBody.Unit | undefined;
}

export namespace ReportsDatasetFieldResponseBody {
    /** Data type of the field.  Valid values: `string`, `integer`, `float`, `timestamp`, `unknown` */
