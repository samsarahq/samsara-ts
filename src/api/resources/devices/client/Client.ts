...
export class Devices {
     ...
     *
     * @param {Samsara.DevicesListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Samsara.DeviceResponseResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraTimeoutError("Timeout exceeded when calling GET /devices.");
                    case "unknown":
                        throw new errors.SamsaraError({
        ...
        return new core.Pageable<Samsara.DevicesGetDevicesResponseBody, Samsara.DeviceResponseResponseBody>({
