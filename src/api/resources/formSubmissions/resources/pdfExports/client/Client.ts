...
export class PdfExports {
     ...
     *
     * @param {SamsaraApi.formSubmissions.PdfExportsGetRequest} request
    ...
    ): core.HttpResponsePromise<SamsaraApi.FormSubmissionsGetFormSubmissionsPdfExportsResponseBody> {
    ...
    private async __get(
        request: SamsaraApi.formSubmissions.PdfExportsGetRequest,
        requestOptions?: PdfExports.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.FormSubmissionsGetFormSubmissionsPdfExportsResponseBody>> {
        const { pdfId } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.FormSubmissionsGetFormSubmissionsPdfExportsResponseBody,
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {SamsaraApi.formSubmissions.PdfExportsCreateRequest} request
     * @param {PdfExports.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link SamsaraApi.UnauthorizedError}
     * @throws {@link SamsaraApi.NotFoundError}
    ...
    public create(
        ...
        requestOptions?: PdfExports.RequestOptions,
    ): core.HttpResponsePromise<SamsaraApi.FormSubmissionsPostFormSubmissionsPdfExportsResponseBody> {
    ...
    private async __create(
        request: SamsaraApi.formSubmissions.PdfExportsCreateRequest,
        requestOptions?: PdfExports.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.FormSubmissionsPostFormSubmissionsPdfExportsResponseBody>> {
        const { id } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        _queryParams["id"] = id;
        const _response = await core.fetcher({
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.FormSubmissionsPostFormSubmissionsPdfExportsResponseBody,
                rawResponse: _response.rawResponse,
            };
        }
