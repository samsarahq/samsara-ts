...
export declare namespace FuelPurchases {
...
export class FuelPurchases {
    protected readonly _options: FuelPurchases.Options;

    constructor(_options: FuelPurchases.Options = {}) {
     ...
     *
     * @param {SamsaraApi.FuelPurchasePostFuelPurchaseRequestBody} request
     * @param {FuelPurchases.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<SamsaraApi.FuelPurchasePostFuelPurchaseResponseBody> {
    ...
    private async __create(
        request: SamsaraApi.FuelPurchasePostFuelPurchaseRequestBody,
        requestOptions?: FuelPurchases.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.FuelPurchasePostFuelPurchaseResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.FuelPurchasePostFuelPurchaseResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling POST /fuel-purchase.");
            case "unknown":
                throw new errors.SamsaraApiError({
