...
export class LiveShares {
     ...
     *
     * @param {Samsara.LiveSharesListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<Samsara.LiveSharingLinkFullResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraTimeoutError("Timeout exceeded when calling GET /live-shares.");
                    case "unknown":
                        throw new errors.SamsaraError({
        ...
        return new core.Pageable<
            Samsara.LiveSharingLinksGetLiveSharingLinksResponseBody,
            Samsara.LiveSharingLinkFullResponseObjectResponseBody
        >({
    ...
    private async __create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraTimeoutError("Timeout exceeded when calling POST /live-shares.");
            case "unknown":
                throw new errors.SamsaraError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
     ...
     *  **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.
     *
     * @param {Samsara.LiveSharesDeleteRequest} request
     * @param {LiveShares.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Samsara.UnauthorizedError}
     * @throws {@link Samsara.NotFoundError}
    ...
    private async __delete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraTimeoutError("Timeout exceeded when calling DELETE /live-shares.");
            case "unknown":
                throw new errors.SamsaraError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __update(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraTimeoutError("Timeout exceeded when calling PATCH /live-shares.");
            case "unknown":
                throw new errors.SamsaraError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
