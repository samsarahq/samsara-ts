...
export declare namespace CarbCtcClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class CarbCtcClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<CarbCtcClient.Options>;

    constructor(options: CarbCtcClient.Options = {}) {
     ...
     * @param {CarbCtcClient.RequestOptions} requestOptions - Request-specific configuration.
     *
