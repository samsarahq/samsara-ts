...
export declare namespace RouteEventsClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class RouteEventsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<RouteEventsClient.Options>;

    constructor(options: RouteEventsClient.Options = {}) {
     ...
     *
     * @param {Samsara.GetRouteEventsStreamRequest} request
     * @param {RouteEventsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public getRouteEventsStream(
        request: Samsara.GetRouteEventsStreamRequest = {},
        requestOptions?: RouteEventsClient.RequestOptions,
    ): core.HttpResponsePromise<Samsara.RoutesGetRouteEventsStreamResponseBody> {
        return core.HttpResponsePromise.fromPromise(this.__getRouteEventsStream(request, requestOptions));
    }

    private async __getRouteEventsStream(
        request: Samsara.GetRouteEventsStreamRequest = {},
        requestOptions?: RouteEventsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Samsara.RoutesGetRouteEventsStreamResponseBody>> {
        const { after, startTime, limit, includeExternalIds } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as Samsara.RoutesGetRouteEventsStreamResponseBody,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/route-events/stream");
    }
}
