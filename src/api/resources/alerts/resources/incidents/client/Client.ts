...
export class Incidents {
     ...
     *
     * @param {SamsaraApi.alerts.IncidentsStreamRequest} request
    ...
    public async stream(
    ...
    ): Promise<core.Page<SamsaraApi.GetWorkflowIncidentResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.alerts.IncidentsStreamRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.AlertsGetIncidentsResponseBody>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.AlertsGetIncidentsResponseBody,
        ...
        return new core.Pageable<
            SamsaraApi.AlertsGetIncidentsResponseBody,
            SamsaraApi.GetWorkflowIncidentResponseObjectResponseBody
        >({
