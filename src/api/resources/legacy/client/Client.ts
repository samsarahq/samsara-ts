...
export class Legacy {
     ...
     *
     * @param {SamsaraApi.LegacyGetVehiclesDriverAssignmentsRequest} request
     * @param {Legacy.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<SamsaraApi.VehiclesDriverAssignmentsGetVehiclesDriverAssignmentsResponseBody> {
    ...
    private async __getVehiclesDriverAssignments(
        request: SamsaraApi.LegacyGetVehiclesDriverAssignmentsRequest = {},
        requestOptions?: Legacy.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.VehiclesDriverAssignmentsGetVehiclesDriverAssignmentsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.VehiclesDriverAssignmentsGetVehiclesDriverAssignmentsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling GET /fleet/vehicles/driver-assignments.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
