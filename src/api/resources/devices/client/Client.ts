...
export class Devices {
     ...
     *
     * @param {SamsaraApi.DevicesListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<SamsaraApi.DeviceResponseResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.DevicesListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.DevicesGetDevicesResponseBody>> => {
                const { models, healthStatuses, includeHealth, after, limit } = request;
                ...
                if (healthStatuses != null) {
                    if (Array.isArray(healthStatuses)) {
                        _queryParams["healthStatuses"] = healthStatuses.map((item) => item);
                    } else {
                        _queryParams["healthStatuses"] = healthStatuses;
                    }
                }
                if (includeHealth != null) {
                    _queryParams["includeHealth"] = includeHealth.toString();
                }
                if (after != null) {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.DevicesGetDevicesResponseBody,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SamsaraApiTimeoutError("Timeout exceeded when calling GET /devices.");
                    case "unknown":
                        throw new errors.SamsaraApiError({
        ...
        return new core.Pageable<SamsaraApi.DevicesGetDevicesResponseBody, SamsaraApi.DeviceResponseResponseBody>({
