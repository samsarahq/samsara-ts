...
<details><summary><code>client.betaApIs.<a href="/src/api/resources/betaApIs/client/Client.ts">cancelSharedAssetsBatch</a>({ ...params }) -> Samsara.AssetSharingAgreementsCancelSharedAssetsBatchResponseBody</code></summary>
<dl>
<dd>
...
```typescript
await client.betaApIs.cancelSharedAssetsBatch({
    data: [{
            id: "12345"
        }]
});
...
**request:** `Samsara.AssetSharingAgreementsCancelSharedAssetsBatchRequestBody` 
