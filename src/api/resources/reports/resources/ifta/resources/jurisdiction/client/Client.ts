...
export declare namespace Jurisdiction {
...
export class Jurisdiction {
    protected readonly _options: Jurisdiction.Options;

    constructor(_options: Jurisdiction.Options = {}) {
     ...
     *
     * @param {SamsaraApi.reports.ifta.JurisdictionGetRequest} request
     * @param {Jurisdiction.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<SamsaraApi.IftaGetIftaJurisdictionReportsResponseBody> {
    ...
    private async __get(
        request: SamsaraApi.reports.ifta.JurisdictionGetRequest,
        requestOptions?: Jurisdiction.RequestOptions,
    ): Promise<core.WithRawResponse<SamsaraApi.IftaGetIftaJurisdictionReportsResponseBody>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as SamsaraApi.IftaGetIftaJurisdictionReportsResponseBody,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SamsaraApiTimeoutError(
                    "Timeout exceeded when calling GET /fleet/reports/ifta/jurisdiction.",
                );
            case "unknown":
                throw new errors.SamsaraApiError({
