 ...
 */
export interface ReadingTriggerContinuousValueObjectResponseBody {
    /** The operation to use when comparing the value to the threshold.  Valid values: `GREATER`, `INSIDE_RANGE`, `LESS`, `OUTSIDE_RANGE` */
    operation: ReadingTriggerContinuousValueObjectResponseBody.Operation;
    ...
    unit?: ReadingTriggerContinuousValueObjectResponseBody.Unit | undefined;
    /** The upper threshold of criticality. Required for RANGE operations. */
    upperThreshold?: number | undefined;
}

export namespace ReadingTriggerContinuousValueObjectResponseBody {
    /** The operation to use when comparing the value to the threshold.  Valid values: `GREATER`, `INSIDE_RANGE`, `LESS`, `OUTSIDE_RANGE` */
