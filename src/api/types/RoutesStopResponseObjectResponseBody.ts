...
export interface RoutesStopResponseObjectResponseBody {
    ...
    address?: SamsaraApi.GoaAddressTinyResponseResponseBody;
    /** List of documents associated with the stop. */
    documents?: SamsaraApi.GoaDocumentTinyResponseResponseBody[];
    ...
    locationLiveSharingLinks?: SamsaraApi.LiveSharingLinkResponseObjectResponseBody[];
    /** Name of the stop */
    name: string;
    /** Notes for the stop */
    notes?: string;
    ...
    singleUseLocation?: SamsaraApi.RoutesSingleUseAddressObjectResponseBody;
