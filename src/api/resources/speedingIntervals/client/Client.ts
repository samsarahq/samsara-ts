...
export class SpeedingIntervals {
     ...
     *
     * @param {Samsara.SpeedingIntervalsStreamRequest} request
    ...
    public async stream(
    ...
    ): Promise<core.Page<Samsara.TripSpeedingIntervalsResponseBody>> {
        ...
        return new core.Pageable<
            Samsara.SpeedingIntervalsGetSpeedingIntervalsResponseBody,
            Samsara.TripSpeedingIntervalsResponseBody
        >({
