...
export class DocumentTypes {
     ...
     *
     * @param {SamsaraApi.DocumentTypesListRequest} request
    ...
    public async list(
    ...
    ): Promise<core.Page<SamsaraApi.GetDocumentTypeResponseObjectResponseBody>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: SamsaraApi.DocumentTypesListRequest,
            ): Promise<core.WithRawResponse<SamsaraApi.DocumentTypesGetDocumentTypesResponseBody>> => {
                const { after } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as SamsaraApi.DocumentTypesGetDocumentTypesResponseBody,
        ...
        return new core.Pageable<
            SamsaraApi.DocumentTypesGetDocumentTypesResponseBody,
            SamsaraApi.GetDocumentTypeResponseObjectResponseBody
        >({
